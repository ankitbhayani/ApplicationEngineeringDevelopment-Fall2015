 ...
 * @author raunak
 */
public class DrugLookUpStoreAssignJPanel extends javax.swing.JPanel {
     ...
     */
    public DrugLookUpStoreAssignJPanel(JPanel userProcessContainer, UserAccount account, PharmaManagerOrganization organization, Enterprise enterprise, EcoSystem ecoSystem) {
            initComponents();
...
/*        int rowCount = tblStoreList.getRowCount();
    ...
    private void initComponents() {
        ...
        workRequestJTable.setFont(new java.awt.Font("Calibri", 0, 13)); // NOI18N
        ...
        btnProcessRequest.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/PatientRole/searchButton.png"))); // NOI18N
        btnProcessRequest.setText("Drug Lookup");
...
*/     
    ...
    private void btnProcessRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessRequestActionPerformed
        ...
        SrchAssignStoreJPanel srchAssignStoreJPanel = new SrchAssignStoreJPanel(userProcessContainer,workRequest, userAccount,organization,enterprise,ecoSystem);
        userProcessContainer.add("SrchAssignStoreJPanel",srchAssignStoreJPanel);
