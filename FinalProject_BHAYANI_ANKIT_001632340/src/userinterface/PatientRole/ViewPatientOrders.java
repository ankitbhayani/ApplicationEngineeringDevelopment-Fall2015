 ...
 */
public class ViewPatientOrders extends javax.swing.JPanel {
     ...
     */
    public ViewPatientOrders(JPanel userProcessContainer,EcoSystem business,UserAccount ua) {
        initComponents();
	...
	this.ua=ua;
	employee = (Patient)ua.getEmployee();
     ...
     public void populateOrderTable(){
        ...
        for(Order o: employee.getPatientDrugOrders().getOrders()){
                Object row[] = new Object[5];
                row[0]=o;
                row[1]=o.getOrderNumber();
                row[2]=o.getStorePharmacist();
    ...
    private void initComponents() {
        ...
        lblPersontext.setText("Patient Name");

        jLabel4.setFont(new java.awt.Font("Cambria", 1, 24)); // NOI18N
        jLabel4.setText("Patient Orders Panel");
        ...
        productTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ordered Date", "Order ID", "StorePharmacist", "Drugs", "Total Order Value"
            }
        ) {
