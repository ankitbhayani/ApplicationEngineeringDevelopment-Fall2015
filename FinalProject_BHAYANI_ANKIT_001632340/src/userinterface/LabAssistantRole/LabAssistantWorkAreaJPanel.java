...
public class LabAssistantWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 90, 375, 96));
        ...
        lblStatus.setFont(new java.awt.Font("Calibri", 3, 14)); // NOI18N
        lblStatus.setForeground(new java.awt.Color(255, 0, 0));
        add(lblStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 60, -1, -1));
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        if (selectedRow < 0){
            lblStatus.setText("Please select a row to process");
            return;
        }
        ...
        if(request.getStatus().equalsIgnoreCase("Pending")){
            ...
            lblStatus.setText("Completed sucessfully");
        }
        else{lblStatus.setText("Request should be assigned first");}
