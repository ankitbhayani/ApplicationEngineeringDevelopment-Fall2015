...
public class OrderStatus extends javax.swing.JPanel {
     ...
     */
    public OrderStatus(JPanel userProcessContainer,Business business,UserAccount ua,Customer customer) {
        initComponents();
	...
	SalesPerson employee = (SalesPerson)ua.getPerson();
        ...
        lblActivity.setText(customer.getCustomerName()+"'s Order List");
        populateOrderTable();
    }
        ...
        for(Order o: customer.getCustomerOrderList().getOrders()){
                Object row[] = new Object[5];
                row[0]=o;
                row[1]=o.getOrderNumber();
                row[2]=o.getSalesperson();
